<body>
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            if (session()->get('level')==1 || session()->get('level')==2)
               { ?>
                <a href="<?=base_url('home/pesanan')?>" class="nav-item nav-link">Pesanan</a>
                <?php
            }else{
            } ?>        
  <?php
           /* if (session()->get('level')==1 || session()->get('level')==2)
               { ?>
                <a href="<?=base_url('home/form')?>" class="nav-item nav-link">Form</a>
                <?php
            }else{
            } ?>
            <?php*/
            if (session()->get('level')==1)
               { ?>
                <a href="<?=base_url('home/laporan')?>" class="nav-item nav-link">Laporan</a>
                <?php
            }else{
            } ?>    
            <?php
            if (session()->get('level')==1)
                ...
                if (session()->get('level')==1)
                    { ?>
                        <a href="<?=base_url('home/transaksi')?>" class="nav-item nav-link">Transaksi</a>
                        <?php
                    ...
                    if (session()->get('level')==1 || session()->get('level')==2)
                        { ?>
                           <!-- <a href="<?=base_url('home/history')?>" class="nav-item nav-link">history</a> -->
                            <?php
                ...
                if (session()->get('level')==1)
                    { ?>
<!--                         <a href="<?=base_url('home/form')?>" class="nav-item nav-link">Form Kasir</a> -->
                        <?php
                ...
                if (session()->get('level')==1)
                    { ?>
                        <a href="<?=base_url('home/setting')?>" class="nav-item nav-link">Setting</a>
